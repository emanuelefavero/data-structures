...
class LinkedList {
  ...
  // * FIND MIDDLE NODE
  // To find the middle (without the length property) we use the "slow and fast pointer" or "tortoise and hare (lepre)" algorithm. It works by having two pointers. One moving one step at a time and one moving two steps at a time. When the fast pointer reaches the end of the linked list, the slow pointer will be at the middle.
  findMiddleNode() {
    let slow = this.head
    let fast = this.head
